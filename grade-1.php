...
<ul class="sp-megamenu-parent menu-rotate hidden-sm hidden-xs"><li ><a  href="index.php"  >Home</a></li>

	<li class="sp-menu-item sp-has-child current-item active"><a  href="curriculum.php"  >Curriculum</a><div class="sp-dropdown sp-dropdown-main sp-menu-right" style="width: 240px;"><div class="sp-dropdown-inner"><ul class="sp-dropdown-items"><li class="sp-menu-item"><a  href="lower-kindergarten-lkg.php"  >Lower Kindergarten(LKG) </a></li><li class="sp-menu-item"><a  href="upper-kindergarten-ukg.php"  >Upper Kindergarten(UKG) </a></li><li class="sp-menu-item current-item active"><a style="color:blue;"  href="grade-1.html"  >Grade 1 </a></li><li class="sp-menu-item"><a  href="syllabus.html"  >Syllabus</a></li></ul></div></div></li>


<li class="sp-menu-item"><a  href="admissions.php"  >Admissions</a></li><li class="sp-menu-item"><a  href="gallery.php"  >Gallery</a></li><li class="sp-menu-item sp-has-child"><a  href="about-us.php"  >About us</a><div class="sp-dropdown sp-dropdown-main sp-menu-right" style="width: 240px;"><div class="sp-dropdown-inner"><ul class="sp-dropdown-items"><li class="sp-menu-item"><a  href="about-us.php"  >About School</a></li><li class="sp-menu-item"><a  href="index0.php"  >Logout</a></li></ul></div></div></li><li class="sp-menu-item"> <button class="button" onclick="window.location.href = 'contact.php';">   Contact us</button>
						</div>
