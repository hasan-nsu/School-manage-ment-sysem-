...
<li class="sp-menu-item current-item active"><a  href="teachers_login.php"  >Teachers Login</a></li><li class="sp-menu-item">
...
<form action="teacher_validate.php" method="post" >
  <div class="container">
    <h1>Register</h1>
    <p>Please fill in this form to create an account.</p>
    <hr>

<label for="usname"><b>User Name</b></label>
